...
// adds Grandma Ople as creator
ApplePie.creator = document.querySelector('p').innerHTML;

// adds ingredients to list
var ingredientList = document.getElementById("ingredient-list").querySelectorAll("li")
for (var i = 0; i < ingredientList.length; i++) {
	ApplePie.ingredients.push(ingredientList[i].innerHTML);
};
...
//console.log(ApplePie.ingredients.length);
...
document.querySelector("img").addEventListener("click", hello);
